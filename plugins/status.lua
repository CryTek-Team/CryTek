...
local function run(msg, matches)
  if matches[1]:lower() == 'nod32' then -- Put everything you like :)
    ...
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /crytek ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "crytek" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (crytek)",-- Put everything you like :)
		"^[!/]([Cc]rytek)"-- Put everything you like :)
    }, 
  run = run
}
